...
namespace ESP.Standard.Data.PostgreSql.Exceptions
{
    ...
    /// </remarks>
    public class BeisenDataException : Exception
    {
        internal BeisenDataException(string instanceName, string connectionString, string errorMessage, string operation, Exception innerException)
