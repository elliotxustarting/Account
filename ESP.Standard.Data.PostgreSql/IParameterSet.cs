...
namespace ESP.Standard.Data.PostgreSql
{
    ...
    {
        private NpgsqlParameterCollection pm;

        internal ParameterSet(NpgsqlParameterCollection sqlParameterCollection)
        {
        ...
        public void AddWithValue(string key, object value, ParameterDirectionWrap direction, int? size, DbType? dbType)
        {
            ...
            NpgsqlParameter sp = new NpgsqlParameter(key, value);
